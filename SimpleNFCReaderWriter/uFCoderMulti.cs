...
namespace SimpleNFCReaderWriter
{
    ...
    public static unsafe class uFCoderMulti
    {
        //--------------------------------------------------------------------------------------------------
#if WIN64
        ...
        public static extern DL_STATUS GetReaderTip(ulong* get_reader_type);

        [DllImport(DLL_NAME, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto, EntryPoint = "GetDlogicCardType")]
        public static extern DL_STATUS GetDlogicCardTip(byte* bCardType);
    }
}
